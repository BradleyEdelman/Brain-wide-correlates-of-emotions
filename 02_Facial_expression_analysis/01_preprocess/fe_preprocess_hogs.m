function fe_preprocess_hogs(data, param)
...
for i_mouse = 1:size(data.mouse,2)
    ...
    [fold, fold_hog] = fe_identify_video_fold(data, i_mouse, 'FACE');
    ...
    for i_fold = 1:size(fold,2)
        ...
        if ~exist(hog_file,'file') || rewrite == 1
            ...
            elseif i_fold > 1 && exist(coord_file,'file')
                ...
                hog = fe_imagesToHogsCellCropAlign_noDLC(fold{i_fold}, fold{1}, param, cropInfo, 'saveFolder', fold_hog{i_fold});
